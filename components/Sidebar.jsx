    ...
    <>
      <div className="hidden md:block fixed left-12 top-1/2 -translate-y-1/2 z-50 group">
        <div className="w-30 group-hover:w-64 transition-[width] duration-300 ease-in-out bg-[#6199c2] text-[rgb(249,229,197)] flex flex-col rounded-2xl overflow-hidden h-150">
          ...
          <Link href='/me' className="relative bg-[rgb(190,75,83)] hover:bg-[rgb(170,60,68)] transition-colors rounded-b-2xl h-16 shrink-0 cursor-pointer flex items-center">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#6199c2] text-[rgb(249,229,197)]">
        <div className="flex flex-row items-center justify-between px-2">
          ...
          <div className="flex items-center justify-center py-3 flex-shrink-0">
            <Link
              href="/me"
              className="w-10 h-10 rounded-full bg-[rgb(190,75,83)] hover:bg-[rgb(170,60,68)] transition-colors flex items-center justify-center"
            >
              <span />
            </Link>
          </div>
